   ...
   static void generateCode(ParseTree t, BufferedWriter writer, int indentLevel) throws IOException {
    ...
    switch (opName(t)) {
        ...
        case "IfStatement":
            ...
            if (elseOrDoubleDots.getText().equals(":")) {
                writer.write(indent);
                writer.write("}\n");
            } else {
                writer.write(indent);
        ...
        case "ElsifStatement":
            ...
            if (elseOrElsif.getText().equals("elsif")) {
                writer.write(indent);
                writer.write("}\n");
            } else {
                writer.write(indent);
    ...
    public static void main(String[] args) throws Exception {
        CharStream stream = CharStreams.fromFileName("gorila.ban");
        GorilaScriptLexer lexer = new GorilaScriptLexer(stream);
        TokenStream tokenStream = new CommonTokenStream(lexer);
        GorilaScriptParser parser = new GorilaScriptParser(tokenStream);
